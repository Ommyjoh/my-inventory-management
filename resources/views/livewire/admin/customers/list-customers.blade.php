<div>
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.listCustomers') }}">Manage Customers / All Customers</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="card flat-card">
        <div class="d-flex justify-content-end m-2">
                <button wire:click="addNewCustomerModal" style="border-radius: 20px" class="btn btn-primary"> <i class="nav-icon fa fa-plus-circle"></i> Add Customer</button>
        </div>
    ...
    <div class="modal fade" id="addSupplierForm" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
            <div class="modal-dialog">
                <form wire:submit.prevent="{{ $editModal ? 'editCustomer' : 'addCustomer' }}">
                    <div class="modal-content">
                        <div class="modal-header bg-primary">
                        @if ($editModal)
                            <h5 class="modal-title text-white" id="exampleModalLabel">Update Customer</h5>
                        @else
                            <h5 class="modal-title text-white" id="exampleModalLabel">Add New Customer</h5>
                        @endif
