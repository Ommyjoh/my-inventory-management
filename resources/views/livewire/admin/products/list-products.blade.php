<div>
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.listProducts') }}">Manage Products / All Products</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="card flat-card">
        <div class="d-flex justify-content-end m-2">
                <button wire:click="addNewProductModal" style="border-radius: 20px" class="btn btn-primary"> <i class="nav-icon fa fa-plus-circle"></i> Add Product</button>
        </div>
        ...
        <table class="table table-bordered">
            ...
            <tbody wire:loading.class="text-muted">
                ...
                <tr>
                    ...
                    <td>
                        <a wire:click = "editProductForm({{ $product }})" href="#"><i class="nav-icon fa fa-edit text-primary mr-2" title="edit"></i></a>
                        <a wire:click = "showDeleteConfirmation({{ $product->id }})" href="#"><i class="nav-icon fa fa-trash text-danger" title="delete"></i></a>
                    </td>
                </tr>
    ...
    <div class="modal fade" id="addSupplierForm" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
            <div class="modal-dialog">
                <form wire:submit.prevent="{{ $editModal ? 'editProduct' : 'addProduct' }}">
                        ...
                        <div class="modal-body">
                                ...
                                @if ($editModal)
                                    <div class="mb-3">
                                        ...
                                        <select wire:model.defer="state.supplier_id" class="form-select @error('supplier_id') is-invalid @enderror" aria-label="Default select example">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select wire:model.defer="state.category_id" class="form-select @error('category_id') is-invalid @enderror" aria-label="Default select example">
